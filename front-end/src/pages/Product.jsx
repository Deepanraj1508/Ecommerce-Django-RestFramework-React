    ...
    <div className="container my-5 py-2">
      <div className="row">
        <div className="col-md-6 py-3">
          <LoadingSkeleton height={400} width={400} />
        </div>
        <div className="col-md-6 py-5">
          <LoadingSkeleton height={30} width={250} />
          <LoadingSkeleton height={90} />
          <LoadingSkeleton height={40} width={70} />
          <LoadingSkeleton height={50} width={110} />
          <LoadingSkeleton height={120} />
          <LoadingSkeleton height={40} width={110} inline={true} />
          <LoadingSkeleton className="mx-3" height={40} width={110} />
        </div>
      </div>
    </div>
  );
    ...
    <div className="d-flex my-4 py-4">
      {[...Array(5)].map((_, index) => (
        <div key={index} className="mx-4">
          <LoadingSkeleton height={400} width={250} />
        </div>
      ))}
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row">
          {loadingProduct ? <LoadingProduct /> : <ShowProduct />}
        </div>
        <div className="row my-5 py-5">
          <div className="d-none d-md-block">
            <h2>You may also like</h2>
            <Marquee pauseOnHover={true} pauseOnClick={true} speed={50}>
              {loadingSimilarProducts ? <LoadingSimilarProducts /> : <ShowSimilarProducts />}
            </Marquee>
          </div>
        </div>
      </div>
